...
class LoginScreenState extends State<LoginScreen>
  ...
  Future<Null> handleSignIn({AuthCredential authCredential}) async {
    ...
    if (authCredential == null){
      ...
      print("authCredential null");
    }else{
      credential = authCredential;
      print("authCredential not null");
    }
    print("Stage 1");
      ...
      //   print("Stage 4");
        ...
        //unawaited(
          Navigator.pushReplacement(context,
            ...
            new MaterialPageRoute(builder: (context) => VuwitAppHome()))
            //)
            ;
                                ...
                                onPressed: () {
                                  ...
                                  if (_name.text.trim().isNotEmpty) {
                                    ...
                                    if (_phone.isNotEmpty &&
                                      ...
                                      // Enigma.toast('Please enter a valid number.');
                            ...
                            RaisedButton(
                                ...
                                onPressed: () {
                                  if (_smsCode.text.length == 6) {
                                    ...
                                    print("Please enter the correct OTP Code");
                                },
                                child: Text('Next')),
                            SizedBox(width: 8.0),
                            RaisedButton(
